...
plot(t,y,type="l",col="blue", xlab ="time", ylab = "Data", main = "Polynomial Regression Of 4th Order")
lines(t,tr4, col="red") 

# PLOT detrended data in new window
plot(t,y_detrended4,type="l",col="black", xlab ="time", ylab = "Data", main = "Residuals Plots")
