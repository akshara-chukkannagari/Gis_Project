...
plot(t,y,type="l",col="blue", xlab ="time", ylab = "Data", main = "Polynomial Regression Of 3rd Order")
lines(t,tr3, col="red") 

# PLOT detrended data in new window
plot(t,y_detrended3,type="l",col="black", xlab ="time", ylab = "Data", main = "Residuals Plots")
