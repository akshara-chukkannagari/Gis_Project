...
# plot(t,y,type="l",col="blue", xlab ="time", ylab = "Data", main = "Moving average Plot")
# 
...
plot(y_reduced[,1],y_reduced[,2],type="l",col="black", xlab ="time", ylab = "Data", main = "Residual Plot")
