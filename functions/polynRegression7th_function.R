...
plot(t,y,type="l",col="blue", xlab ="time", ylab = "Data", main = "Polynomial Regression Of 7th Order")
lines(t,tr7, col="red") 

# PLOT detrended data in new window
plot(t,y_detrended7,type="l",col="black", xlab ="time", ylab = "Data", main = "Residuals Plots")
