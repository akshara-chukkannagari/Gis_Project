...
###        2. Initial value for alpha --> y-axis offset; graphically determined for x=0 by user!
### OUTPUT: 1. trendline as y-values
###         2. Reduced data as y-values
###         3. X_hat with coefficients alpha & beta


exponentialGrowth_function<-function (time, data, alpha) {
...
plot(time,y,type="l",col="blue", xlab ="time", ylab = "Data", main = "Exponential Growth PLot")
lines(time,trendline, col="red") 

# PLOT detrended data in new window
plot(time,y_reduced,type="l",col="black", xlab ="time", ylab = "Data", main = "Residulas plot")
