...
polynRegression6th_function<-function (time, data) {
...
plot(t,y,type="l",col="blue", xlab ="time", ylab = "Data", main = "Polynomial Regression Of 6th Order")
lines(t,tr6, col="red") 

# PLOT detrended data in new window
plot(t,y_detrended6,type="l",col="black", xlab ="time", ylab = "Data", main = "Residuals Plots")
