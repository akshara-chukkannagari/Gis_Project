...
stationarity_function<-function (time, data) {
...
text1 <- paste("Intervals tested :",div,";    .")
text2 <- paste("Number of intervals significantly different from the first:",diff,";    .")
